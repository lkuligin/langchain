...
class _VertexAICommon(_VertexAIBase):
    ...
    def _stream_to_str(self, streaming_response: Iterator[GenerationChunk]) -> str:
        texts = [chunk.text for chunk in streaming_response]
        return "".join(texts)
    ...
    def _predict(
        ...
        **kwargs: Any,
        ...
        if self.streaming:
            ...
            return self._stream_to_str(streaming_response=response)
        params = self._get_params(stop=stop, **kwargs)
...
class VertexAI(_VertexAICommon, LLM):
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """
        return self._predict(prompt, stop, run_manager=run_manager, **kwargs)
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        params = self._get_params(stop=stop, **kwargs)
        responses = self.client.predict_streaming(prompt=prompt, **params)
